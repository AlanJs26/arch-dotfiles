            ...
            Repeater { // Window repeater
                ...
                delegate: OverviewWindow {
                    ...
                    xOffset: {
                        ...
                        return (root.workspaceImplicitWidth + workspaceSpacing) * workspaceColIndex - (monitor?.x * root.scale)// - 135
                    }
                    yOffset: (root.workspaceImplicitHeight + workspaceSpacing) * workspaceRowIndex - (monitor?.y * root.scale)// + 30
